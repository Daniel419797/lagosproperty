      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="hidden md:flex items-center space-x-6">
            <a href="#features" className="text-gray-700 hover:text-gray-900 font-medium transition-colors" aria-label="Features">Features</a>
            <a href="#how-it-works" className="text-gray-700 hover:text-gray-900 font-medium transition-colors" aria-label="How It Works">How It Works</a>
            <a href="#testimonials" className="text-gray-700 hover:text-gray-900 font-medium transition-colors" aria-label="Testimonials">Testimonials</a>
            <a href="#contact" className="text-gray-700 hover:text-gray-900 font-medium transition-colors" aria-label="Contact">Contact</a>
            ...
            <div className="flex items-center space-x-3">
              ...
              <button
                ...
                disabled={!connected}
                className={`px-6 py-2 rounded-xl transition-all duration-200 transform ${
                  connected
    ...
    <section className="py-20 bg-gradient-to-br from-blue-900 via-purple-900 to-indigo-900 text-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="text-center mt-12">
          <button 
            onClick={() => setIsWalletModalOpen(true)}
            className={`px-8 py-4 rounded-xl font-semibold transition-all duration-200 transform hover:scale-105 flex items-center justify-center space-x-2 mx-auto ${
              connected
                ? 'bg-green-100 text-green-800 hover:bg-green-200'
                : 'bg-white text-blue-900 hover:bg-blue-50'
            }`}
            aria-label={connected ? 'Wallet Connected' : 'Connect Your Cardano Wallet'}
          >
            <Wallet className="h-5 w-5" />
            <span>{connected ? 'Wallet Connected' : 'Connect Your Cardano Wallet'}</span>
          </button>
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <WalletConnection
        ...
        onWalletConnected={(wallet) => setConnectedWallet(wallet)}
      />
    </div>
  );
};
