...
const WalletConnection: React.FC<WalletConnectionProps> = ({
  ...
  const handleConnect = async (walletKey: string) => {
    ...
    try {
      const walletInfo = await connectWallet(walletKey);
      if (walletInfo) {
  ...
  const getWalletConfig = (walletName: string) => {
    return SUPPORTED_WALLETS.find(w => w.name === walletName);
  };
          ...
          {!connectedWallet ? (
            <div className="space-y-6">
              <div className="text-center">
                ...
                <p className="text-gray-600 text-sm">
                  Connect your Cardano wallet to access blockchain-verified property features and secure transactions.
                </p>
              </div>
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-xl p-4">
                <div className="flex items-start space-x-2">
                  ...
                  <div>
                    <p className="text-blue-800 text-sm font-medium">Why Connect Your Wallet?</p>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gray-50 rounded-xl p-4 space-y-4">
                <div className="flex justify-between items-center">
                  ...
                  <span className={`px-2 py-1 rounded-full text-xs font-semibold ${
                    ...
                    {connectedWallet.network.charAt(0).toUpperCase() + connectedWallet.network.slice(1)}
                  </span>
                </div>
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-bold text-gray-900">
                    {formatADA(connectedWallet.balance)}
                  </span>
                </div>
              ...
              <div className="flex space-x-3">
                <button
                  onClick={onClose}
                  className="flex-1 bg-gradient-to-r from-green-600 to-emerald-600 text-white py-3 rounded-xl font-semibold hover:from-green-700 hover:to-emerald-700 transition-all duration-200"
                >
